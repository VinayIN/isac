...
function Links() {
  ...
  return (
    <div className='flex flex-column py-6 mx-4'>
      ...
      <AnchorLink id="admission-procedure">
        <Card title="Admission Procedure at Brandenburg Technical University" className='m-2 mb-8 shadow-4'>
      ...
      <AnchorLink id="accomodation">
        <Card title="Finding Accomodation" className='m-2 mb-8 shadow-4'>
          <div style={{height: '500px', 'overflow': 'auto' }}>
      ...
      <AnchorLink id="city-registration">
        <Card title="City Registration" className='m-2 mb-8 shadow-4'>
      ...
      <AnchorLink id="bank-account">
        <Card title="Opening Bank Account" className='m-2 mb-8 shadow-4'>
          <div style={{height: '500px', 'overflow': 'auto' }}>
      ...
      <AnchorLink id="reaching-cottbus">
        <Card title="Reaching Cottbus" className='m-2 mb-8 shadow-4'>
          <div style={{height: '500px', 'overflow': 'auto' }}>
      ...
      <AnchorLink id="emergency-contact">
        <Card title="Emgergency Contacts" className='m-2 mb-8 shadow-4'>
          <div style={{height: '500px', 'overflow': 'auto' }}>
