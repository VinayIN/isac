...
function Events() {
  ...
  const formatPostedOn = (rowData) =>
    dateUtils.format(rowData, "parsedPostedOn");
  ...
  return (
    <>
      <Head>
        <title>ISAC - Events & Announcements</title>
        <meta
          name="description"
          content="Events and Announcements by Indian Student Association Cottbus"
        />
        <meta
          name="keywords"
          content="ISAC, events, announcements, BTU Cottbus"
        />
      </Head>
